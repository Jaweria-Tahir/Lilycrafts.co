      ...
      <div className="relative z-10">
        ...
        <main className="max-w-4xl mx-auto px-6 py-20 relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <h1 className="font-serif text-5xl md:text-7xl font-light leading-[0.9] mb-6 text-slate-950">
              Where is your <br /><em className="italic font-medium text-rose">Treasure?</em>
            </h1>
            <p className="font-serif text-base text-slate-700/80 mb-8 max-w-lg mx-auto leading-relaxed italic">
          ...
          <div className="max-w-2xl mx-auto mb-20">
            <form onSubmit={track} className="relative group flex flex-col sm:flex-row gap-3">
              <input 
                ...
                className="flex-1 px-8 py-6 rounded-full border-2 border-rose-50 bg-white/50 backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-rose-200 transition-all font-serif text-xl italic text-black"
                required 
              />
              <button 
                type="submit" 
                disabled={loading}
                className="px-10 py-6 bg-slate-900 text-white rounded-full font-bold shadow-lg hover:bg-slate-800 transition-transform hover:scale-105 active:scale-95 flex items-center justify-center gap-2 uppercase tracking-widest text-sm"
              >
          ...
          {result && (
            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-10 duration-700">
              ...
              <div className="bg-white/60 backdrop-blur-xl border-2 border-white/80 p-8 md:p-14 rounded-[3.5rem] shadow-2xl">
              ...
              <div className="bg-slate-900 rounded-[3rem] p-10 text-white flex flex-col md:flex-row items-center justify-between gap-8 shadow-xl">

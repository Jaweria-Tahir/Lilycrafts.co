    ...
    <div className="min-h-screen relative flex flex-col font-serif overflow-hidden">
      ...
      <main className="flex-grow max-w-7xl mx-auto px-4 md:px-8 py-12 relative z-10">
        ...
        <div className="text-center mb-16 space-y-2">
          ...
          <h1 className="text-5xl md:text-7xl font-medium text-slate-800 tracking-tight">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-24">
          {CATEGORY_DATA.map((cat, index) => (
            <button 
              ...
              className="group relative h-60 flex flex-col items-center justify-center p-8 backdrop-blur-md bg-white/40 border border-white/60 rounded-[2.5rem] transition-all duration-500 hover:bg-white/60 hover:shadow-[0_20px_50px_rgba(200,150,160,0.15)] hover:-translate-y-2 active:scale-95 overflow-hidden"
            >
              ...
              <h3 className="relative text-2xl font-medium text-slate-800 text-center leading-tight group-hover:text-[#9b4d4d] transition-colors duration-300">
                {cat.name}
              </h3>
